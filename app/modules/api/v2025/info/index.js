	...
	try {
		...
		const data = {
			...
			music: [
				...
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-1.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-2.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-3.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-4.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-5.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-6.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-7.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-8.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-9.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-10.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-11.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-12.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-13.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-14.mp3?v=${_versionCache}`,
				`${_staticUrl}public/frontend/assets/musics/nhac-dam-cuoi-15.mp3?v=${_versionCache}`,
			],
			video: {
	...
	try {
		...
		const data = {
			bride: {
				...
				bank: show_bank == 1 ? `${_staticUrl}public/frontend/assets/images/bank_bride.jpg?v=${_versionCache}` : "",
			...
			groom: {
				...
				bank: show_bank == 1 ? `${_staticUrl}public/frontend/assets/images/bank_groom.jpg?v=${_versionCache}` : "",
