...
const mod_config = {
    module : 'weddings',
    resource : 'message',
    collection : 'wd_messages',
    route : 'weddings/message',
    view : 'message',
    alias : 'message'
};
...
//Get add
message.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
message.post('/add', async function(req, res){
    try {
...
//Get edit
message.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
message.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
message.get('/import', function(req, res){
    try {
 ...
 *
 */
message.post('/import', async function(req, res){
    try {
...
//GET export
message.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
message.post('/export', async function(req, res){
    try {
...
//delete
message.post('/delete', async function (req, res) {
...
//Get detail
message.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
message.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
message.post("/report", async function (req, res) {
	try {
