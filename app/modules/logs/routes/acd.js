...
const acd = express.Router();
acd.get('/', async function(req, res) {
...
//Get add
acd.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
acd.post('/add', async function(req, res){
    try {
...
//Get edit
acd.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
acd.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
acd.get('/import', function(req, res){
    try {
 ...
 *
 */
acd.post('/import', async function(req, res){
    try {
...
//GET export
acd.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
acd.post('/export', async function(req, res){
    try {
...
//delete
acd.post('/delete', async function (req, res) {
...
//Get detail
acd.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
acd.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
acd.post("/report", async function (req, res) {
	try {
