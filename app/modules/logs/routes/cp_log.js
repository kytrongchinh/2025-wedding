...
const cp_log = express.Router();
cp_log.get('/', async function(req, res) {
...
//Get add
cp_log.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
cp_log.post('/add', async function(req, res){
    try {
...
//Get edit
cp_log.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
cp_log.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
cp_log.get('/import', function(req, res){
    try {
 ...
 *
 */
cp_log.post('/import', async function(req, res){
    try {
...
//GET export
cp_log.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
cp_log.post('/export', async function(req, res){
    try {
...
//delete
cp_log.post('/delete', async function (req, res) {
...
//Get detail
cp_log.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
cp_log.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
cp_log.post("/report", async function (req, res) {
	try {
